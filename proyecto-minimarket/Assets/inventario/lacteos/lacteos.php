...
<?php
    ...
    include_once("agregar-producto-lacteos.php");
    ...
    <div class="principal" >
        ...
        <nav class="nav-inventario">
            <ul class="barra-nav-inventario">
                ...
                <li class="inventario-nav-li"><i class=""></i><a href="#">Lacteos</a></li>
    ...
    <section class="container-table" >
        <table class="table">
            <thead>
                <tr class="fila-titulo-btn">
                    <th class="fila-titulo" colspan="5">Inventario de Lacteos</th>
            ...
            id_proveedor,id_unid_medida, existencias FROM producto_lacteos";
        ...
        <div class="overlay" id="overlay">
            <div class="popup" id="popup">
                ...
                <hr class="popup-hr">
                <form action="lacteos.php" method="post" class="form-popup" id="form-popup">
