...
<?php
    ...
    include_once("agregar-producto.php");
...
<!-- Estilo CSS -->
<link rel="stylesheet" href="abarrotes.css">
<!-- import BOOTSRAP -->
...
<main class="d-flex flex-nowrap">
    ...
    <!-- Cambiar class active para mostar la ventana actual-->
        ...
        <div class="dropdown">
            ...
            <img src="../../images/usuario.png" alt="" width="32" height="32" class="rounded-circle me-2">
    ...
    <div class="principal" >
        ...
        <nav class="nav-inventario">
            <ul class="barra-nav-inventario">
                <li class="inventario-nav-li"><i class=""></i><a href="../carnicos/carnicos.php">Carnicos</a></li>
                <li class="inventario-nav-li"><i class=""></i><a href="../lacteos/lacteos.php">Lacteos</a></li>
                <li class="inventario-nav-li"><i class=""></i><a href="#">Abarrotes</a></li>
    ...
    <section class="container-table" >
        <table class="table">
            <thead>
                <tr class="fila-titulo-btn">
                    <th class="fila-titulo" colspan="5">Inventario de Abarrotes</th>
            ...
            id_proveedor, id_unid_medida, existencias FROM producto_abarrotes";
        ...
        <div class="overlay" id="overlay">
            <div class="popup" id="popup">
                ...
                <hr class="popup-hr">
                <form action="" method="post" class="form-popup" id="form-popup">
                    <div id="grupo_name-product" class="">
                    ...
                    <div>
                        <button class="popup-btn" type="submit">Agregar</button>
                    </div>
...
<script src="validar-agregar-pro.js"></script>
