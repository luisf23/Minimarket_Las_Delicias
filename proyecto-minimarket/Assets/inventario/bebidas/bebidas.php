...
<?php
    ...
    include_once("agregar-producto-bebidas.php");
    ...
    <div class="principal" >
        ...
        <nav class="nav-inventario">
            <ul class="barra-nav-inventario">
                ...
                <li class="inventario-nav-li"><i class=""></i><a href="#">Bebidas</a></li>
            </ul>
        </nav>
    <section class="container-table" >
        <table class="table">
            <thead>
                <tr class="fila-titulo-btn">
                    <th class="fila-titulo" colspan="5">Inventario de Bebidas</th>
            ...
            id_proveedor,id_unid_medida, existencias FROM producto_bebidas";
        ...
        <div class="overlay" id="overlay">
            <div class="popup" id="popup">
                ...
                <hr class="popup-hr">
                <form action="bebidas.php" method="post" class="form-popup" id="form-popup">
